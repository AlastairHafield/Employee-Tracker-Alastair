    ...
    inquirer.prompt([
        ...
        .then((answer) => {
            ...
            connect.query(roles, (err, data) => {
                if (err) throw err;
                const department_const = data.map(({ name, id }) => ({ name: name, value: id }));
                inquirer.prompt([
                    {
                        type: "list",
                    ...
                    .then((departments_constChoice) => {
                        const department_const = departments_constChoice.departments_const;
                        params.push(department_const);
...
addEmployee = () => {
    inquirer.prompt([
        ...
        .then((answer) => {
            ...
            const roles_const = `SELECT roles.id, roles.title FROM roles`;
